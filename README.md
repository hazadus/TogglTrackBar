...
> Это моё первое приложения для macOS на Swift/SwiftUI.
...
>
> Основа приложения была собрана в "черновом" репо, а сюда код аккуратно переносился для чистой истории коммитов.
> В коде оставлено множество подробных комментариев, помогающих разобраться в синтаксисе и деталях реализации.
...
- При кликах по пунктам меню (статистика времени работы, текущая запись времени, email пользователя) в браузере открываются соответствующие разделы веб-приложения TogglTrack. 
